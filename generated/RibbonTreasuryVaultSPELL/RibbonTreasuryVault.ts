...
export class CollectManagementFee extends ethereum.Event {
  get params(): CollectManagementFee__Params {
    return new CollectManagementFee__Params(this);
  }
}

export class CollectManagementFee__Params {
  _event: CollectManagementFee;

  constructor(event: CollectManagementFee) {
    this._event = event;
  }
...
export class CollectPerformanceFee extends ethereum.Event {
  get params(): CollectPerformanceFee__Params {
    return new CollectPerformanceFee__Params(this);
  }
}

export class CollectPerformanceFee__Params {
  _event: CollectPerformanceFee;

  constructor(event: CollectPerformanceFee) {
    this._event = event;
  }
...
export class DistributePremium extends ethereum.Event {
  get params(): DistributePremium__Params {
    return new DistributePremium__Params(this);
  }
}

export class DistributePremium__Params {
  _event: DistributePremium;

  constructor(event: DistributePremium) {
    this._event = event;
  }
...
export class RibbonTreasuryVault__depositReceiptsResult {
  value0: i32;
  value1: BigInt;
  value2: BigInt;
...
export class RibbonTreasuryVault__vaultParamsResult {
  value0: boolean;
  value1: i32;
  value2: Address;
  value3: Address;
...
export class RibbonTreasuryVault extends ethereum.SmartContract {
  static bind(address: Address): RibbonTreasuryVault {
    return new RibbonTreasuryVault("RibbonTreasuryVault", address);
  }
  ...
  try_GNOSIS_EASY_AUCTION(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "GNOSIS_EASY_AUCTION",
      "GNOSIS_EASY_AUCTION():(address)",
      []
  ...
  depositReceipts(param0: Address): RibbonTreasuryVault__depositReceiptsResult {
    let result = super.call(
      "depositReceipts",
    ...
    return new RibbonTreasuryVault__depositReceiptsResult(
      result[0].toI32(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_depositReceipts(
    param0: Address
  ): ethereum.CallResult<RibbonTreasuryVault__depositReceiptsResult> {
    let result = super.tryCall(
      "depositReceipts",
      "depositReceipts(address):(uint16,uint104,uint128)",
      [ethereum.Value.fromAddress(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new RibbonTreasuryVault__depositReceiptsResult(
        value[0].toI32(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  optionState(): RibbonTreasuryVault__optionStateResult {
    let result = super.call(
      "optionState",
    ...
    return new RibbonTreasuryVault__optionStateResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toBigInt()
    );
  ...
  try_optionState(): ethereum.CallResult<
    RibbonTreasuryVault__optionStateResult
  > {
    let result = super.tryCall(
      "optionState",
      "optionState():(address,address,uint32)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new RibbonTreasuryVault__optionStateResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toBigInt()
      )
  ...
  shareBalances(account: Address): RibbonTreasuryVault__shareBalancesResult {
    let result = super.call(
      "shareBalances",
    ...
    return new RibbonTreasuryVault__shareBalancesResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_shareBalances(
    account: Address
  ): ethereum.CallResult<RibbonTreasuryVault__shareBalancesResult> {
    let result = super.tryCall(
      "shareBalances",
      "shareBalances(address):(uint256,uint256)",
      [ethereum.Value.fromAddress(account)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new RibbonTreasuryVault__shareBalancesResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  vaultParams(): RibbonTreasuryVault__vaultParamsResult {
    let result = super.call(
      "vaultParams",
    ...
    return new RibbonTreasuryVault__vaultParamsResult(
      result[0].toBoolean(),
      result[1].toI32(),
      result[2].toAddress(),
      result[3].toAddress(),
  ...
  try_vaultParams(): ethereum.CallResult<
    RibbonTreasuryVault__vaultParamsResult
  > {
    let result = super.tryCall(
      "vaultParams",
      "vaultParams():(bool,uint8,address,address,uint56,uint104)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new RibbonTreasuryVault__vaultParamsResult(
        value[0].toBoolean(),
        value[1].toI32(),
        value[2].toAddress(),
        value[3].toAddress(),
  ...
  vaultState(): RibbonTreasuryVault__vaultStateResult {
    let result = super.call(
      "vaultState",
    ...
    return new RibbonTreasuryVault__vaultStateResult(
      result[0].toI32(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_vaultState(): ethereum.CallResult<RibbonTreasuryVault__vaultStateResult> {
    let result = super.tryCall(
      "vaultState",
      "vaultState():(uint16,uint104,uint104,uint128,uint128)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new RibbonTreasuryVault__vaultStateResult(
        value[0].toI32(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  whitelistMap(param0: Address): boolean {
    let result = super.call("whitelistMap", "whitelistMap(address):(bool)", [
      ethereum.Value.fromAddress(param0)
    ]);
  ...
  try_whitelistMap(param0: Address): ethereum.CallResult<boolean> {
    let result = super.tryCall("whitelistMap", "whitelistMap(address):(bool)", [
      ethereum.Value.fromAddress(param0)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  withdrawals(param0: Address): RibbonTreasuryVault__withdrawalsResult {
    let result = super.call(
      "withdrawals",
    ...
    return new RibbonTreasuryVault__withdrawalsResult(
      result[0].toI32(),
      result[1].toBigInt()
    );
  }
  ...
  try_withdrawals(
    param0: Address
  ): ethereum.CallResult<RibbonTreasuryVault__withdrawalsResult> {
    let result = super.tryCall(
      "withdrawals",
      "withdrawals(address):(uint16,uint128)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new RibbonTreasuryVault__withdrawalsResult(
        value[0].toI32(),
        value[1].toBigInt()
      )
    );
...
export class ConstructorCall__Inputs {
  ...
  get _gnosisEasyAuction(): Address {
...
export class ChargeAndDistributeCall extends ethereum.Call {
  get inputs(): ChargeAndDistributeCall__Inputs {
    return new ChargeAndDistributeCall__Inputs(this);
  }

  get outputs(): ChargeAndDistributeCall__Outputs {
    return new ChargeAndDistributeCall__Outputs(this);
  }
}

export class ChargeAndDistributeCall__Inputs {
  _call: ChargeAndDistributeCall;

  constructor(call: ChargeAndDistributeCall) {
    this._call = call;
  }
}

export class ChargeAndDistributeCall__Outputs {
  _call: ChargeAndDistributeCall;
...
export class ConcludeOptionsSaleCall extends ethereum.Call {
  get inputs(): ConcludeOptionsSaleCall__Inputs {
    return new ConcludeOptionsSaleCall__Inputs(this);
  }

  get outputs(): ConcludeOptionsSaleCall__Outputs {
    return new ConcludeOptionsSaleCall__Outputs(this);
  }
}

export class ConcludeOptionsSaleCall__Inputs {
  _call: ConcludeOptionsSaleCall;

  constructor(call: ConcludeOptionsSaleCall) {
    this._call = call;
  }
}

export class ConcludeOptionsSaleCall__Outputs {
  _call: ConcludeOptionsSaleCall;
