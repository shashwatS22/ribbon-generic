...
export class LiquidityGaugeV5__reward_dataResultValue0Struct extends ethereum.Tuple {
  get token(): Address {
...
export class LiquidityGaugeV5 extends ethereum.SmartContract {
  static bind(address: Address): LiquidityGaugeV5 {
    return new LiquidityGaugeV5("LiquidityGaugeV5", address);
  }
  ...
  rbn_token(): Address {
    let result = super.call("rbn_token", "rbn_token():(address)", []);

    return result[0].toAddress();
  }

  try_rbn_token(): ethereum.CallResult<Address> {
    let result = super.tryCall("rbn_token", "rbn_token():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  veboost_proxy(): Address {
    let result = super.call("veboost_proxy", "veboost_proxy():(address)", []);

    return result[0].toAddress();
  }

  try_veboost_proxy(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "veboost_proxy",
      "veboost_proxy():(address)",
      []
  ...
  reward_data(arg0: Address): LiquidityGaugeV5__reward_dataResultValue0Struct {
    let result = super.call(
      "reward_data",
  ...
  try_reward_data(
    arg0: Address
  ): ethereum.CallResult<LiquidityGaugeV5__reward_dataResultValue0Struct> {
    let result = super.tryCall(
      "reward_data",
      "reward_data(address):((address,address,uint256,uint256,uint256,uint256))",
      [ethereum.Value.fromAddress(arg0)]
...
export class Set_killedCall extends ethereum.Call {
  get inputs(): Set_killedCall__Inputs {
    return new Set_killedCall__Inputs(this);
  }

  get outputs(): Set_killedCall__Outputs {
    return new Set_killedCall__Outputs(this);
  }
}

export class Set_killedCall__Inputs {
  _call: Set_killedCall;

  constructor(call: Set_killedCall) {
    this._call = call;
  }

  get _is_killed(): boolean {
    return this._call.inputValues[0].value.toBoolean();
  }
}

export class Set_killedCall__Outputs {
  _call: Set_killedCall;
