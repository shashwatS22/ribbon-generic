...
export class yvHEGIC__strategiesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class yvHEGIC extends ethereum.SmartContract {
  static bind(address: Address): yvHEGIC {
    return new yvHEGIC("yvHEGIC", address);
  }
  ...
  strategies(arg0: Address): yvHEGIC__strategiesResult {
    let result = super.call(
      "strategies",
    ...
    return new yvHEGIC__strategiesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_strategies(
    arg0: Address
  ): ethereum.CallResult<yvHEGIC__strategiesResult> {
    let result = super.tryCall(
      "strategies",
      "strategies(address):(uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(arg0)]
